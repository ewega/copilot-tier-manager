...
Save this as `setup/setup-cost-centers.sh` and run it to create all cost centers and budgets in one go.
...
```bash
chmod +x setup/setup-cost-centers.sh
./setup/setup-cost-centers.sh your-enterprise-slug
```
